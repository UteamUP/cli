...
func init() {
	Register(&Domain{
		...
		Actions: []Action{
			...
			{
				Name:        "scope-get",
				Description: "Read current named owning project, stage and deliverable scope",
				ToolName:    "UteamupWorkorderProjectScopeGet",
				HTTPMethod:  "GET",
				RESTPath:    "by-guid/{workorderGuid}/project-scope",
				Args:        []ArgDef{{Name: "workorderGuid", Description: "Work order GUID", Required: true, Type: "uuid"}},
			},
			{
				Name:        "scope-update",
				Description: "Change only reviewed owning scope; retain requestGuid and all expected scope identities for retries",
				ToolName:    "UteamupWorkorderProjectScopeUpdate",
				HTTPMethod:  "PUT",
				RESTPath:    "by-guid/{workorderGuid}/project-scope",
				Args:        []ArgDef{{Name: "workorderGuid", Description: "Work order GUID", Required: true, Type: "uuid"}},
				Flags: []FlagDef{{Name: "from-json", Description: "Reviewed root JSON object with requestGuid, expectedUpdatedAt and all three expected GUID fields; empty GUID asserts unlinked",
