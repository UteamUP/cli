		...
		Actions: []Action{
			...
			},
			{
				...
				Flags: []FlagDef{
					...
					{Name: "unit-of-measure-guid", Description: "Unit directory GUID for an unlinked requirement; linked stock supplies its own unit", Type: "uuid"},
					{Name: "requested-quantity", Description: "Exact requested quantity", Required: true, Type: "float"},
			...
			},
			{
				...
				Flags: []FlagDef{
					...
					{Name: "unit-of-measure-guid", Description: "Unit directory GUID for an unlinked requirement; linked stock supplies its own unit", Type: "uuid"},
					{Name: "requested-quantity", Description: "Positive quantity in the selected unit", Required: true, Type: "float"},
					{Name: "audience", Description: "Wholesalers | Tenants | Both", Required: true, Type: "string"},
