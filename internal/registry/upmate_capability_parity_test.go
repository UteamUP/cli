...
func TestEnabledUpmateCapabilitiesHaveCLIRegistrations(t *testing.T) {
	expected := []string{
		...
		"UteamupIoTRulesList",
		"UteamupITManagementDashboard",
		"UteamupITManagementAlertsList",
		"UteamupITManagementAlertGet",
		"UteamupITManagementAlertAcknowledge",
		"UteamupITManagementAlertResolve",
		...
		"UteamupTutorialList",
		"UteamupTutorialGet",
		"UteamupUpmateScheduleOptimizationPreview",
		"UteamupUpmateScheduleOptimizationExplain",
		"UteamupUpmateMaintenancePlanSuggest",
		"UteamupUpmateMaintenanceDueExplain",
		"UteamupUpmateFieldnoteTranscribe",
