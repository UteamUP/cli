		...
		Actions: []Action{
			...
			},
			{
				...
				Flags: append(paginationFlags(),
					...
					FlagDef{Name: "search", Description: "Search project name, code or owner across every page", Type: "string"},
					FlagDef{Name: "sort-by", Description: "scheduleRisk, name, endDate, budgetBurn or priority", Default: "scheduleRisk", Type: "string"},
					FlagDef{Name: "sort-descending", Description: "Sort descending", Default: true, Type: "bool"},
					FlagDef{Name: "owner-guid", Description: "Filter by project owner GUID", Type: "string"},
					FlagDef{Name: "priority", Description: "Optional project priority", Type: "int"},
					FlagDef{Name: "overdue-only", Description: "Only unfinished projects past their end date", Type: "bool"},
				),
			},
		},
	})
