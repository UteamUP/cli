		...
		Actions: []Action{
			{
				...
				Flags: []FlagDef{
					...
					{Name: "user-guid", BodyName: "userGuid", Description: "Exact source user public GUID; use at most one source filter", Type: "string"},
					{Name: "contractor-profile-guid", BodyName: "contractorProfileGuid", Description: "Exact source contractor profile public GUID", Type: "string"},
					{Name: "contractor-crew-guid", BodyName: "contractorCrewGuid", Description: "Exact source crew public GUID", Type: "string"},
					{Name: "asset-guid", BodyName: "assetGuid", Description: "Exact source asset public GUID across equipment and vehicle resources", Type: "string"},
					{Name: "location-guid", BodyName: "locationGuid", Description: "Exact source location public GUID", Type: "string"},
