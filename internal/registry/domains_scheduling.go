...
func init() {
	...
	Register(&Domain{Name: "shift-assignment", Description: "Manage shift user assignments", APIPath: "/api/shiftuserassignment", Actions: []Action{
		...
		{Name: "user-date", Description: "Get a user's shift assignment for a date", ToolName: "UteamupShiftUserAssignmentGetByUserAndDate", HTTPMethod: "GET", RESTPath: "user/{userId}/date/{date}", Args: []ArgDef{{Name: "userId", Description: "User ID", Required: true, Type: "string"}, {Name: "date", Description: "Date", Required: true, Type: "string"}}},
