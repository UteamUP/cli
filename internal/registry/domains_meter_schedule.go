		...
		Actions: []Action{
			...
			},
			{
				...
				Flags: []FlagDef{
					...
					{Name: "interval-seconds", Description: "Reading interval in seconds (minimum 300 = 5 minutes)", Required: true, Type: "int"},
			...
			},
			{
				...
				Flags: []FlagDef{
					{Name: "interval-seconds", Description: "New reading interval in seconds (minimum 300)", Type: "int"},
